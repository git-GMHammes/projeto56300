 ...
 *   saas_tenants_id     BIGINT NOT NULL  (FK → user_004_saas_tenants.id)
 *   role                VARCHAR(50) NOT NULL DEFAULT 'member'
 *
 * Validação de unicidade composta (user_management_id + saas_tenants_id) é responsabilidade do Processor.
 */
class CreateRequest
{
    public function rules(): array
    {
        return [
            ...
            'saas_tenants_id'    => 'required|is_natural_no_zero',
    ...
    public function messages(): array
    {
        return [
            ...
            'saas_tenants_id' => [
                'required'           => 'O campo saas_tenants_id é obrigatório',
                'is_natural_no_zero' => 'O campo saas_tenants_id deve ser um número inteiro positivo',
            ],
            'role' => [

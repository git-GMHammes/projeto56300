...
namespace App\Models\V1\UserCustomerFiles;

use App\Models\V1\BaseTableModel;

/**
 * Model de escrita para a tabela user_customer_files.
 *
...
class SqlTableModel extends BaseTableModel
{
     ...
     * Exclui: uuid/checksum (hashes — busca exata), size (int), user_customer_id (FK int).
     */

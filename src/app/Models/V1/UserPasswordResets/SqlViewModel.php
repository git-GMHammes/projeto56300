...
namespace App\Models\V1\UserPasswordResets;

use App\Models\V1\BaseViewModel;

/**
 * Model de leitura para a view view_user_password_resets (quando existir).
 *
 * Atualmente a tabela user_password_resets não possui uma view SQL dedicada.
 ...
 *
 * Tabela de referência: user_password_resets

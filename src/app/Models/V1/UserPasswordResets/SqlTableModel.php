...
/**
 * Model de escrita para a tabela user_password_resets.
 *
 * Responsável por todas as operações CRUD diretas na tabela física.
 *
 * Tabela: user_password_resets
...
class SqlTableModel extends BaseTableModel
{
     ...
     *
     * @param int $userId ID do usuário em user_management
     */
     ...
     *
     * @param int $id PK do registro em user_password_resets
     */

...
namespace App\Controllers\Api\V1\User\UserTenants;

use App\Controllers\Api\V1\BaseResourceTableController;
use App\Requests\V1\User\UserTenants\CreateRequest;
use App\Requests\V1\User\UserTenants\UpdateRequest;
use App\Services\V1\User\UserTenants\Processor;

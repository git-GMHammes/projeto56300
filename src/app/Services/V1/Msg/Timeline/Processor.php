...
namespace App\Services\V1\Msg\Timeline;

use App\Libraries\Msg\ContentFilter;
use App\Models\V1\Msg\Timeline\SqlTableModel;
use App\Models\V1\Msg\Timeline\SqlViewModel;
...
class Processor extends MsgBaseService
{
    ...
    {
        unset($data['tenant_id'], $data['user_management_id']);

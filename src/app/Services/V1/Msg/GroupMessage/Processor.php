...
namespace App\Services\V1\Msg\MessageGroup;

use App\Libraries\Msg\ContentFilter;
use App\Models\V1\Msg\MessageGroup\SqlTableModel;
use App\Models\V1\Msg\MessageGroup\SqlViewModel;
...
class Processor extends MsgBaseService
{
    ...
    protected function validateOnCreate(array $data): ?array
    {
        ...
        if (!empty($data['reply_to_id']) && !$this->existsMessageGroup((int) $data['reply_to_id'])) {
    ...
    {
        unset($data['group_id'], $data['user_management_id'], $data['reply_to_id']);

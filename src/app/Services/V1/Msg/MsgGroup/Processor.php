...
namespace App\Services\V1\Msg\MsgGroup;

use App\Libraries\Msg\ContentFilter;
use App\Models\V1\Msg\MsgGroup\SqlTableModel;
use App\Models\V1\Msg\MsgGroup\SqlViewModel;
use App\Services\V1\Msg\MsgBaseService;

/**
 * Service de negócio para grupos de chat (msg_004_group).
 *
 * O criador (created_by) recebe role admin automaticamente via MessageGroupMember\Processor.

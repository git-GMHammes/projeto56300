...
namespace App\Services\V1\Msg\GroupRead;

use App\Models\V1\Msg\GroupRead\SqlTableModel;
use App\Models\V1\Msg\GroupRead\SqlViewModel;
...
class Processor extends MsgBaseService
{
    ...
    protected function validateOnCreate(array $data): ?array
    {
        ...
        if (!empty($data['group_id']) && !empty($data['user_management_id'])
            && $this->groupReadExists((int) $data['group_id'], (int) $data['user_management_id'])
        ) {

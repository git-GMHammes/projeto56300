/**
 * theme.ts — Tomador de decisão do tema visual ativo
 *
 * Altere THEME para trocar o visual de toda a aplicação.
 * O ThemeProvider lê este valor como padrão na inicialização.
 *
 * Variantes disponíveis:
 *   'Purple' | 'Dark' | 'Light' | 'Green' | 'Blue' | 'Red'
 */
